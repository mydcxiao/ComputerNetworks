...
#define LOCAL_PORT "22906" // port number to be bound with UDP socket

#define MAXBUFLEN 10000 // buffer size

using namespace std;

/* read cs.txt and set up a database using map.
...
int main(void) {
    ...
    while(1) {
        ...
        // multiquery
            ...
            cout <<"The ServerCS received a multiquery request from the Main Server."<<endl;
